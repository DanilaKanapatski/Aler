...
const lookList = document.querySelectorAll('.look-list li');
const loadMoreBtn = document.querySelector('.look-btn');
...
function hideExtraNews() {
    ...
    if (currentlyShown >= lookList.length) {
...
let currentPage = 1;
let totalPages = Math.ceil(lookList.length / itemsPerPage);
